...
import testImage from "../Learning-Development/imgs/courses.jpg";
...
const Attendance = () => {
  ...
  const logToDashbard = async () => {
    ...
    await axios
      .post("https://dmgian.corp-dmg.com/attendance/login/", {
        body: encryptedBody,
      })
      .then((res) => {
        window.location.href = "https://dmgian.corp-dmg.com/attendance/";
        return;
      });
  };
